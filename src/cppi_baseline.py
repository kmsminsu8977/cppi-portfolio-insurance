...
PROJECT = {"analysis_type": "cppi", "category": "Dynamic Portfolio Insurance", "columns": ["date", "risky_return", "safe_return"], "floor_ratio": 0.9, "initial_value": 100.0, "max_risky_weight": 1.0, "methods": ["cushion은 portfolio value와 고정 floor의 차이로 정의한다.", "위험자산 비중은 multiplier x cushion/value로 계산하고 0~100%로 제한한다.", "시장 경로는 floor와 cushion 변화가 보이도록 구성한 합성 수익률이다."], "module_name": "cppi_baseline", "multiplier": 3.0, "objective": "고정 floor와 multiplier를 사용해 위험자산 노출이 어떻게 동적으로 변하는지 계산한다.", "question": "초기 보호수준을 유지하면서 상승장 참여도를 높이려면 multiplier가 어떤 역할을 하는가?", "rows": [["2025-09", 0.032, 0.003], ["2025-10", -0.028, 0.003], ["2025-11", 0.041, 0.002], ["2025-12", 0.01, 0.003], ["2026-01", -0.055, 0.003], ["2026-02", 0.026, 0.002]], "sample_name": "strategy_returns.csv", "title_en": "CPPI Portfolio Insurance", "title_ko": "CPPI 포트폴리오 보험"}
